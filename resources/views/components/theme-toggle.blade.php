<div>
    ...
    <label class="flex items-center justify-center cursor-pointer w-8 h-8 hover:bg-neutral-100 lg:hover:bg-neutral-200 dark:hover:bg-neutral-700/50 dark:lg:hover:bg-neutral-800 rounded-full" for="light-switch">
